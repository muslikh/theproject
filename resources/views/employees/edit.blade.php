                    ...
                    <div class="card-body">
                        <form action="{{ route('employees.update',$employees->id) }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="first_nm" id="first_nm" value="{{ $employees->first_nm}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="last_nm" class="col-sm-2 col-form-label">Last Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="last_nm" id="last_nm" value="{{ $employees->last_nm}}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select  class="form-control" name="company_id" id="company_id">
                                        ...
                                        <option value="{{ $c->id }}"  {{($employees->company_id == $c->id) ?'selected' :''}}>{{ $c->name }}</option>
                                        @endforeach
                                    </select>
